...
const BASE_TASKS: TaskDef[] = [
  ...
  { id: "sys-b-1", category: "各種システムのチェック", label: "POSのチェック（大井町店）",            icon: <Monitor className={iconSize} /> },
  { id: "sys-b-2", category: "各種システムのチェック", label: "POSのチェック（大森南店）",            icon: <Monitor className={iconSize} /> },
  { id: "sys-b-3", category: "各種システムのチェック", label: "POSのチェック（天満店）",              icon: <Monitor className={iconSize} /> },
  { id: "sys-b-4", category: "各種システムのチェック", label: "POSのチェック（戸越銀座駅前店）",      icon: <Monitor className={iconSize} /> },
  { id: "sys-b-5", category: "各種システムのチェック", label: "POSのチェック（大田中央店）",          icon: <Monitor className={iconSize} /> },
  { id: "sys-b-6", category: "各種システムのチェック", label: "POSのチェック（川崎新町店）",          icon: <Monitor className={iconSize} /> },
  { id: "sys-b-7", category: "各種システムのチェック", label: "POSのチェック（幸塚越店）",            icon: <Monitor className={iconSize} /> },
...
const CAT_CONFIG: Record<string, CatConfig> = {
  "各種システムのチェック":         { border: "border-blue-400",   badge: "bg-blue-100 text-blue-700",   icon: <Monitor className="w-4 h-4" /> },
