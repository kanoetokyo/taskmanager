...
## 重要バッジが時間経過でリセットされるバグ修正 (2026-05-08)
- [x] ポーリング更新時にimportantフラグが上書きされる原因を特定
- [x] サーバー側getActiveでimportantフィールドが正しく返されているか確認
- [x] フロントエンドの自動保存でimportantが正しく送信されているか確認
- [x] 修正後の動作確認

## 重要バッジが更新ボタンでリセットされるバグ（再発）修正 (2026-05-08)
- [ ] 更新ボタン押下直後にDBのimportant値を確認
- [ ] getActiveプロシージャのimportantフィールド返却を確認
- [ ] ポーリング更新時のDB読み込みuseEffectでimportantが正しく反映されるか確認
- [ ] 修正後の動作確認
